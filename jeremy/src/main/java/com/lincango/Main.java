...
import com.lincango.PruebaP.MetodoPago;
import com.lincango.PruebaP.Miembro;
import com.lincango.PruebaP.PagoTarjeta;
import com.lincango.PruebaP.PagoTransferencia;
...
Miembro miembro1 = new Miembro("Carlos Mendoza");
System.out.println("\n--- Creación de un Segundo Objeto (Lo estático no se repite) ---");
Miembro miembro2 = new Miembro("Ana Gómez");
System.out.println();
...
miembro1.definirPlanSemanal(planCarlos);
int[][] datosMinutos = miembro1.getMinutosPorEjercicio();
...
System.out.println("Total minutos entrenados: " + miembro1.calcularTotalMinutos() + " min.");
...
MetodoPago pasarela;
pasarela = new PagoTarjeta();
pasarela.procesarPago(mensualidad);
pasarela = new PagoTransferencia();
pasarela.procesarPago(mensualidad);
}
    }
